...
// снимаются здесь, до него.
//
// Готовые разборщики JWCC (тот же hujson) берут «//», «/* */» и висячие
// запятые, но «#» отвергают — проверено. А «#» в манифестах уже написан:
// так работал JSON::PP, так сказано в документации, такие файлы лежат у
// людей на хостах. Значит препроцессор нужен в любом случае, и один
// проход лучше двух механизмов подряд.
