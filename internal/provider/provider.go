...
type Provider interface {
	...
	// Plan возвращает шаги, которые приведут хост к описанному состоянию.
	//
	// Пустой список без ошибки значит «менять нечего» — и это же ответ на
	// правило нуля: нет ключа в манифесте, делать нечего. Отличить одно
	// от другого можно по Configured.
	Plan(ctx context.Context, m *manifest.Manifest, f *facts.Facts) ([]plan.Step, error)
